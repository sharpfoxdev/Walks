    ...
    public partial class Seedingdatafordifficultiesandregions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("805cf177-98d0-4faa-a110-bfd147fb2f61"), "Hard" },
                    { new Guid("8ee116e1-24c8-4421-97ec-75d6904d33c7"), "Easy" },
                    { new Guid("cacdc277-499a-4232-95f5-a5e1f5767d1c"), "Medium" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("805cf177-98d0-4faa-a110-bfd147fb2f61"));
